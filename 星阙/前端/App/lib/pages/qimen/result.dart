...
class _QiMenResultPageState extends State<QiMenResultPage> {
  ...
  void _shareImage() async {
    ...
    await fluwx.share(WeChatShareImageModel(source!, thumbnail: thumbnail, scene: scene));
  }

  Future<void> saveImageToGallery(Uint8List bytes) async {
    final result = await ImageGallerySaver.saveImage(bytes, quality: 100, name: "screenshot");
              ...
              children: [
                              ...
                              children: [
                                GestureDetector(
                                    onTap: () {
                                      if(locked) return;
                                      setState(() {
                                        lunar = lunar.getSolar().prevHour(2).getLunar();
                                ...
                                GestureDetector(
                                    onTap: () {
                                      if(locked) return;
                                      setState(() {
                                        lunar = lunar.getSolar().nextHour(2).getLunar();
                                        eightChar = EightChar.fromLunar(lunar);
                                        eightChar.setSect(1);
                                        update();
                                      });
                            ...
                            child: Text.rich(
                              ...
                              TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text: getShenShaBranch(
                                        ShenShaUtil.OTHER_DAY_STEMS, '日德', eightChar.getDayGan()),
                                    style: TextStyle(
                                      color: const Color(0x99393b41),
                                      fontSize: 30.sp,
                                      fontWeight: FontWeight.w600,
                                            ...
                                            children: [
                                              ...
                                              Align(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: NonBaziShensha(lunar: lunar),
                                                ),
                                              ),
                                            ],
                                          ),
                            ...
                            TableCell(
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    Visibility(
                                      visible: '辰巳'.contains(ShenShaUtil.OTHER_DAY_BRANCH['日马']![ma.branch]!.join('')),
                                      child: Align(
                                        alignment: Alignment.topRight,
                                        child: Padding(
                                          padding:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              result.tianpan['1'] ?? '',
                                              style: TextStyle(
                                                color: '壬癸'.contains(result.tianpan['1']!) ? const Color(0xffc0281c)
                                                    : '辛壬'.contains(result.tianpan['1']!) ? const Color(0xff945b3c)
                                            ...
                                            Text(
                                              result.shen['1']!,
                                              style: TextStyle(
                                                color: '虎' == result.shen['1']! ? const Color(0xfff1ac62) : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                              ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: '开惊'.contains(result.men['1']!.substring(0, 1)) ? const Color(0xffff6f00) : const Color(0xff222426),
                                          fontSize: 36.sp,
                                          fontWeight: FontWeight.w900,
                                        ),
                                      ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        '巽',
                                        style: TextStyle(
                                          color: (kong.xunKong.contains('辰') || kong.xunKong.contains('巳')) ? const Color(0xff3371ca) : const Color(0xffcccccc),
                                          fontSize: 24.sp,
                                          fontWeight: FontWeight.w900,
                                          height: 1,
                                        ),
                            ...
                            TableCell(
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    Visibility(
                                      visible: '午' == ShenShaUtil.OTHER_DAY_BRANCH['日马']![ma.branch]!.join(''),
                                      child: Align(
                                        alignment: Alignment.topRight,
                                        child: Padding(
                                          padding:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              result.tianpan['2'] ?? '',
                                              style: TextStyle(
                                                color: '辛' == result.tianpan['2']! ? const Color(0xffc0281c)
                                                    :  const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                            ...
                                            Text(
                                              result.shen['2']!,
                                              style: TextStyle(
                                                color: '虎' == result.shen['2']! ? const Color(0xfff1ac62) : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                              ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: result.men['2']!.substring(0, 1) == '休' ? const Color(0xffff6f00) : const Color(0xff222426),
                                          fontSize: 36.sp,
                                          fontWeight: FontWeight.w900,
                                        ),
                                      ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        '离',
                                        style: TextStyle(
                                          color: kong.xunKong.contains('午') ? const Color(0xff3371ca) : const Color(0xffcccccc),
                                          fontSize: 24.sp,
                                          fontWeight: FontWeight.w900,
                                          height: 1,
                                        ),
                            ...
                            TableCell(
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    Visibility(
                                      visible: '未申'.contains(ShenShaUtil.OTHER_DAY_BRANCH['日马']![ma.branch]!.join('')),
                                      child: Align(
                                        alignment: Alignment.topRight,
                                        child: Padding(
                                          padding:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              result.tianpan['3'] ?? '',
                                              style: TextStyle(
                                                color: '己' == result.tianpan['3']! ? const Color(0xffc0281c)
                                                    : '甲癸'.contains(result.tianpan['3']!) ? const Color(0xff945b3c)
                                                    :  const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                            ...
                                            Text(
                                              result.shen['3']!,
                                              style: TextStyle(
                                                color: '虎' == result.shen['3']! ? const Color(0xfff1ac62) : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                              ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: '伤杜'.contains(result.men['3']!.substring(0, 1)) ? const Color(0xffff6f00) : const Color(0xff222426),
                                          fontSize: 36.sp,
                                          fontWeight: FontWeight.w900,
                                        ),
                                      ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        '坤',
                                        style: TextStyle(
                                          color: (kong.xunKong.contains('未') || kong.xunKong.contains('申')) ? const Color(0xff3371ca) : const Color(0xffcccccc),
                                          fontSize: 24.sp,
                                          fontWeight: FontWeight.w900,
                                          height: 1,
                                        ),
                            ...
                            TableCell(
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    Visibility(
                                      visible: '卯' == ShenShaUtil.OTHER_DAY_BRANCH['日马']![ma.branch]!.join(''),
                                      child: Align(
                                        alignment: Alignment.topRight,
                                        child: Padding(
                                          padding:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              result.tianpan['4'] ?? '',
                                              style: TextStyle(
                                                color: '戊' == result.tianpan['4']! ? const Color(0xffc0281c)
                                                    : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                            ...
                                            Text(
                                              result.shen['4']!,
                                              style: TextStyle(
                                                color: '虎' == result.shen['4']! ? const Color(0xfff1ac62) : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                              ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: '开惊'.contains(result.men['4']!.substring(0, 1)) ? const Color(0xffff6f00) : const Color(0xff222426),
                                          fontSize: 36.sp,
                                          fontWeight: FontWeight.w900,
                                        ),
                                      ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        '震',
                                        style: TextStyle(
                                          color: kong.xunKong.contains('卯') ? const Color(0xff3371ca) : const Color(0xffcccccc),
                                          fontSize: 24.sp,
                                          fontWeight: FontWeight.w900,
                                          height: 1,
                                        ),
                            ...
                            TableCell(
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    Visibility(
                                      visible: '酉' == ShenShaUtil.OTHER_DAY_BRANCH['日马']![ma.branch]!.join(''),
                                      child: Align(
                                        alignment: Alignment.topRight,
                                        child: Padding(
                                          padding:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              result.shen['6']!,
                                              style: TextStyle(
                                                color: '虎' == result.shen['6']! ? const Color(0xfff1ac62) : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                              ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: '景' == result.men['6']!.substring(0, 1)
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        '兑',
                                        style: TextStyle(
                                          color: kong.xunKong.contains('酉') ? const Color(0xff3371ca) : const Color(0xffcccccc),
                                          fontSize: 24.sp,
                                          fontWeight: FontWeight.w900,
                                          height: 1,
                                        ),
                            ...
                            TableCell(
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    Visibility(
                                      visible: '寅丑'.contains(ShenShaUtil.OTHER_DAY_BRANCH['日马']![ma.branch]!.join('')),
                                      child: Align(
                                        alignment: Alignment.bottomLeft,
                                        child: Padding(
                                          padding:
                                          EdgeInsets.only(bottom: 16.w, left: 16.w),
                                          child: SvgPicture.asset(
                                            'assets/svgs/horse.svg',
                                            width: 26.w,
                                            height: 20.w,
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              result.tianpan['7'] ?? '',
                                              style: TextStyle(
                                                color: '庚' == result.tianpan['7']! ? const Color(0xffc0281c)
                                                    : '丁己庚'.contains(result.tianpan['7']!) ? const Color(0xff945b3c)
                                                    : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                            ...
                                            Text(
                                              result.shen['7']!,
                                              style: TextStyle(
                                                color: '虎' == result.shen['7']! ? const Color(0xfff1ac62) : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                              ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: '伤杜'.contains(result.men['7']!.substring(0, 1))
                                              ? const Color(0xffff6f00)
                                              : const Color(0xff222426),
                                          fontSize: 36.sp,
                                          fontWeight: FontWeight.w900,
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        '艮',
                                        style: TextStyle(
                                          color: (kong.xunKong.contains('丑') || kong.xunKong.contains('寅')) ? const Color(0xff3371ca) : const Color(0xffcccccc),
                                          fontSize: 24.sp,
                                          fontWeight: FontWeight.w900,
                                          height: 1,
                                        ),
                            ...
                            TableCell(
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    Visibility(
                                      visible: '子' == ShenShaUtil.OTHER_DAY_BRANCH['日马']![ma.branch]!.join(''),
                                      child: Align(
                                        alignment: Alignment.topRight,
                                        child: Padding(
                                          padding:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              result.shen['8']!,
                                              style: TextStyle(
                                                color: '虎' == result.shen['8']! ? const Color(0xfff1ac62) : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                              ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: '生死'.contains(result.men['8']!.substring(0, 1))
                                              ? const Color(0xffff6f00)
                                              : const Color(0xff222426),
                                          fontSize: 36.sp,
                                          fontWeight: FontWeight.w900,
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        '坎',
                                        style: TextStyle(
                                          color: kong.xunKong.contains('子') ? const Color(0xff3371ca) : const Color(0xffcccccc),
                                          fontSize: 24.sp,
                                          fontWeight: FontWeight.w900,
                                          height: 1,
                                        ),
                            ...
                            TableCell(
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    Visibility(
                                      visible: '戌亥'.contains(ShenShaUtil.OTHER_DAY_BRANCH['日马']![ma.branch]!.join('')),
                                      child: Align(
                                        alignment: Alignment.topRight,
                                        child: Padding(
                                          padding:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              result.tianpan['9'] ?? '',
                                              style: TextStyle(
                                                color: '乙丙戊'.contains(result.tianpan['9']!) ? const Color(0xff945b3c) : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                              ),
                                            ...
                                            Text(
                                              result.shen['9']!,
                                              style: TextStyle(
                                                color: '虎' == result.shen['9']! ? const Color(0xfff1ac62) : const Color(0xff393b41),
                                                fontSize: 36.sp,
                                                fontWeight: FontWeight.w900,
                                                height: 1,
                                              ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: '景' == result.men['9']!.substring(0, 1) ? const Color(0xffff6f00) : const Color(0xff222426),
                                          fontSize: 36.sp,
                                          fontWeight: FontWeight.w900,
                                        ),
                                      ),
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        '乾',
                                        style: TextStyle(
                                          color: (kong.xunKong.contains('戌') || kong.xunKong.contains('亥')) ? const Color(0xff3371ca) : const Color(0xffcccccc),
                                          fontSize: 24.sp,
                                          fontWeight: FontWeight.w900,
                                          height: 1,
                                        ),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text('击刑', style: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w900))
                        ],
                      ),
                      Row(
                        children: [
                          ...
                          Text('入墓', style: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w900))
                        ],
                      ),
                      Row(
                        children: [
                          ...
                          Text('门迫', style: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w900))
                        ],
                      ),
                      Row(
                        children: [
                          ...
                          Text('空亡', style: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w900))
                        ],
                      ),
                      Row(
                        children: [
                          ...
                          Text('驿马', style: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w900))
                        ],
                      )
                    ],
                ),
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: Text(
                                    gender?.alias ?? '请选择性别',
                                    style: TextStyle(
                                      color: gender == null ? const Color(0x99393b41) : const Color(0xff222426),
                                      fontSize: 30.sp,
                                      fontWeight: FontWeight.w700,
                                    ),
                                  ),
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      SinglePicker(
                                        value: zodiac ?? '鼠',
                                        options: LunarUtil.SHENGXIAO.where((element) => element.isNotEmpty).map((element) => PickerItem(label: element, value: element)).toList(),
                                        mapper: (option) => PickerItem(label: option.label, value: option.value),
                                        onChange: (item) {
                                          setState(() {
                                            zodiac = item.value;
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        color: zodiac != null ? const Color(0xff222426) : const Color(0x99393b41),
                                        fontSize: 30.sp,
                                        fontWeight: FontWeight.w700,
                                      ),
                                    ),
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    ArchiveSvc.record(item).then((res) {
                      if(res.statusCode == 200) {
                        Log.d(res.data);
                        if(res.data['code'] == 0) {
                          toast('保存成功~');
