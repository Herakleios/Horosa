      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              onPressed: () async {
                final image = await screenshotController.capture(); // Capture the Scaffold screenshot
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              TimeStemsPlainText(xunKong: xunKong, branch: tianpan['巳']!, stems: tiangan['巳']!,),
                              TimeStemsPlainText(xunKong: xunKong, branch: tianpan['午']!, stems: tiangan['午']!,),
                              TimeStemsPlainText(xunKong: xunKong, branch: tianpan['未']!, stems: tiangan['未']!,),
                              TimeStemsPlainText(xunKong: xunKong, branch: tianpan['申']!, stems: tiangan['申']!,),
                            ],
                          ),
                          SizedBox(height: 8.w),
                          // Middle Section
                          Row(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  TimeStemsPlainText(xunKong: xunKong, branch: tianpan['辰']!, stems: tiangan['辰']!,),
                                  SizedBox(height: 8.w),
                                  TimeStemsPlainText(xunKong: xunKong, branch: tianpan['卯']!, stems: tiangan['卯']!,),
                                ],
                              ),
                              SizedBox(width: 10.w),
                              Column(
                              ...
                              Column(
                                children: [
                                  TimeStemsPlainText(xunKong: xunKong, branch: tianpan['酉']!, stems: tiangan['酉']!,),
                                  SizedBox(height: 8.w),
                                  TimeStemsPlainText(xunKong: xunKong, branch: tianpan['戌']!, stems: tiangan['戌']!,),
                                ],
                              ),
                              SizedBox(width: 10.w),
                              Column(
                          ...
                          Row(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              TimeStemsPlainText(xunKong: xunKong, branch: tianpan['寅']!, stems: tiangan['寅']!,),
                              TimeStemsPlainText(xunKong: xunKong, branch: tianpan['丑']!, stems: tiangan['丑']!,),
                              TimeStemsPlainText(xunKong: xunKong, branch: tianpan['子']!, stems: tiangan['子']!,),
                              TimeStemsPlainText(xunKong: xunKong, branch: tianpan['亥']!, stems: tiangan['亥']!,),
                            ],
                          ),
                          SizedBox(height: 8.w),
                          // Second Row
                      ...
                      SizedBox(width: 18.w),
                      Padding(
                        padding: EdgeInsets.only(bottom: input.guaType == 2 ? 54.w : 0.w),
                        child: Flex(
                          direction: input.guaType == 1 ? Axis.vertical : Axis.horizontal,
                          children: [
                            Column(
                              children: [
                                Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 4.w),
                                    Text(
                                      result.sanchuan['1']!.split('')[1] == '空'
                                          ? '    '
                                          : result.sanchuan['1']!.split('')[1],
                                      style: TextStyle(
                                        color: const Color(0xff88898d),
                                        fontSize: 30.sp,
                                        fontWeight: FontWeight.w600,
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 4.w),
                                    Text(
                                      result.sanchuan['2']!.split('')[1] == '空'
                                          ? '    '
                                          : result.sanchuan['2']!.split('')[1],
                                      style: TextStyle(
                                        color: const Color(0xff88898d),
                                        fontSize: 30.sp,
                                        fontWeight: FontWeight.w600,
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 4.w),
                                    Text(
                                      result.sanchuan['3']!.split('')[1] == '空'
                                          ? '    '
                                          : result.sanchuan['3']!.split('')[1],
                                      style: TextStyle(
                                        color: const Color(0xff88898d),
                                        fontSize: 30.sp,
                                        fontWeight: FontWeight.w600,
...
class TimeStemsPlainText extends StatelessWidget {
  const TimeStemsPlainText({super.key, required this.xunKong, required this.branch, required this.stems});
