...
class _LiuRenFormPageState extends State<LiuRenFormPage> {
  ...
  void initState() {
    ...
    setState(() {
      _time = Calendar(type: CalendarType.solar, value: Solar.fromDate(DateTime.now()));
      _ast = Calendar(type: CalendarType.solar, value: _calculateAST(_time.value));
    });
  }
                    ...
                    Row(
                      children: [
                        HorosaRadio(
                          ...
                          checked: _layoutType.value == LayoutType.horizontal.value,
                          onChange: (val) {
                            setState(() {
                              _layoutType = val;
                            });
