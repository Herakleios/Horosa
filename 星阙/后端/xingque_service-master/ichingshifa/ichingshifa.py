...
class Iching():
    ...
    def gangzhi(self, year, month, day, hour, minute):
        ...
        yTG, mTG, dTG, hTG = "{}{}".format(self.tiangan[cdate.getYearGZ().tg],
                                           self.dizhi[cdate.getYearGZ().dz]), "{}{}".format(
            self.tiangan[cdate.getMonthGZ().tg], self.dizhi[cdate.getMonthGZ().dz]), "{}{}".format(
            self.tiangan[cdate.getDayGZ().tg], self.dizhi[cdate.getDayGZ().dz]), "{}{}".format(
            self.tiangan[cdate.getHourGZ(dd[3]).tg], self.dizhi[cdate.getHourGZ(dd[3]).dz])
        if year < 1900:
    ...
    def dc_gua(self, gua, find_gua_wuxing):
    ...
    def decode_gua(self, gua, daygangzhi, find_gua_wuxing):
        fivestars = self.data.get("五星")
        eightgua = self.data.get("數字排八卦")
        sixtyfourgua = self.data.get("數字排六十四卦")
        su_yao = self.data.get("二十八宿配干支")
        ...
        try:
            ...
            for fu_val in fu_arr:
                fu_num = fu_gua_lq.index(fu_val)
                fuyao = [str(g == fu_val) for g in fu_gua_lq].index('True')
                fuyao1 = fu_gua_lq[fu_num] + fu_gua_gang[fu_num] + fu_gua_zhi[fu_num] + fu_gua_wu[fu_num]
                fu_val_yao = {"伏神所在爻": lq[fuyao], "伏神六親": fu_val, "伏神排爻數字": fu_num,
                              "本卦伏神所在爻": lq[fu_num] + t[fu_num] + d[fu_num] + w[fu_num], "伏神爻": fuyao1}
                fu_yao.append(fu_val_yao)
    ...
    def decode_two_gua(self, bengua, ggua, daygangzhi):
        ...
        sixtyfourgua = self.data.get("數字排六十四卦")
        find_gua_wuxing = self.multi_key_dict_get(self.data.get("八宮卦五行"),
                                                  self.multi_key_dict_get(sixtyfourgua, bengua))
        b = self.decode_gua(ggua, daygangzhi,find_gua_wuxing)
        try:
    ...
    def display_pan(self, year, month, day, hour, minute):
        ...
        e = "六神　　伏神　　本　　　卦　　　　　　　　　　　 　　之　　　卦\n"
        f = "玄武 　　　　　 {} {}{}{} {}{}　　　　　{} {}{}{} {}{}　\n".format(b1[5], b2[5], b3[5], b4[5], b5[5], bg[5], g1[5],
                                                                     g2[5], g3[5], g4[5], g5[5], gb1[5])
        g = "白虎 　　　　　 {} {}{}{} {}{}　　　　　{} {}{}{} {}{}  \n".format(b1[4], b2[4], b3[4], b4[4], b5[4], bg[4], g1[4],
                                                                      g2[4], g3[4], g4[4], g5[4], gb1[4])
        h = "螣蛇 　　　　　 {} {}{}{} {}{}　　　　　{} {}{}{} {}{}  \n".format(b1[3], b2[3], b3[3], b4[3], b5[3], bg[3], g1[3],
                                                                      g2[3], g3[3], g4[3], g5[3], gb1[3])
        i = "勾陳 　　　　　 {} {}{}{} {}{}　　　　　{} {}{}{} {}{}  \n".format(b1[2], b2[2], b3[2], b4[2], b5[2], bg[2], g1[2],
                                                                      g2[2], g3[2], g4[2], g5[2], gb1[2])
        j = "朱雀 　　　　　 {} {}{}{} {}{}　　　　　{} {}{}{} {}{}  \n".format(b1[1], b2[1], b3[1], b4[1], b5[1], bg[1], g1[1],
                                                                      g2[1], g3[1], g4[1], g5[1], gb1[1])
        k = "青龍 　　　　　 {} {}{}{} {}{}　　　　　{} {}{}{} {}{}  \n\n\n".format(b1[0], b2[0], b3[0], b4[0], b5[0], bg[0],
                                                                          g1[0], g2[0], g3[0], g4[0], g5[0], gb1[0])
        l = "【大衍筮法】\n"
        try:
